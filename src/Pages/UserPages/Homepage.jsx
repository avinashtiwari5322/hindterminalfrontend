...
import { Calendar, MapPin, Users, FileText, Clock, AlertTriangle } from 'lucide-react';
...
const HeightWorkPermit = () => {
  ...
  const ppeItems = [
    'Safety Helmet', 'Safety Jacket', 'Safety Shoes', 'Gloves', 'Safety Goggles', 'Face Shield',
    'Dust Mask', 'Ear plug/Earmuff', 'Anti Slip footwear', 'Safety Net', 'Anchor Point/Lifelines',
    'Self retracting Lifeline (SRL)', 'Full body harness with lanyard or shock absorbers'
  ];
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-gray-600">Authorization for safe access, platforms, or working arrangement at heights of 1.8 meters and above</p>
            </div>
            ...
            <table className="w-full border-collapse border border-gray-300">
              ...
              <tbody>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-green-800">
                    Equipment should be properly isolated from all sources of energy before start of work.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-red-800">
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-red-800">
                    Never perform general work without a safety jacket or safety shoes.
                  </td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="border border-gray-300 px-4 py-3 text-center font-medium">5</td>
                  <td className="border border-gray-300 px-4 py-3 text-green-800">
                    All draining of oil should be in closed system as the draining of oil on floor will make the work area and area around the work unsafe.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-red-800">
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-green-800">
                    Ensure proper illumination of workplace while working in dark.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-red-800">
                    All works at height shall be discontinued during rain/high wind/floods.
                  </td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="border border-gray-300 px-4 py-3 text-center font-medium">7</td>
                  <td className="border border-gray-300 px-4 py-3 text-green-800">
                    Use of approved type full body safety harness along with lifeline is must for working at height of 2.0 m and above, Use of safety helmet and shoe is mandatory for all work sites.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-red-800">
                    Do not continue the job in case scaffold is sagging unduly, report to ISSUER or RECEIVER.
                  </td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="border border-gray-300 px-4 py-3 text-center font-medium">8</td>
                  <td className="border border-gray-300 px-4 py-3 text-green-800">
                    Receiver should ensure that the lifting machine (crane), tools and tackles are properly tested and SWL and date of testing is displayed on equipment.
                  </td>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-green-800">
                    Barricading of the area below lifting machine (crane), chain pulley blocks etc, should be ensured before starting the job.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-red-800"></td>
                </tr>
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-green-800">
                    Remove all scraps, unused material from site on completion of work.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-red-800"></td>
                </tr>
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-green-800">
                    Receiver/worker should know the nearest fire alarm point, fire order, emergency contact no., escape route and location assembly points.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-red-800"></td>
                </tr>
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-green-800">
                    After the completion of the job, copies of work permit should be returned to the ISSUER.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-red-800"></td>
                </tr>
              </tbody>
